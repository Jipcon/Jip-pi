...
PolicyBundle is immutable throughout the entire Task; per-candidate state updates fast facts after each step and aggregates after each turn; only after the Task ends can the Optimizer publish a future version.
