...
export class SessionManager {
	...
	/**
	 * Persist the current session immediately, even when it has no assistant message yet.
	 * Normal CLI/TUI sessions remain lazy; GUI hosts opt in through the RPC command.
	 */
	persistSession(): string | undefined {
		if (!this.persist || !this.sessionFile) return undefined;
		if (this.flushed) return this.sessionFile;
